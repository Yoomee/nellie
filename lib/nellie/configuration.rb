...
module Nellie
  ...
  module Configuration
    # An array of valid keys in the options hash when configuring a {Nellie::API}
    VALID_OPTIONS_KEYS = [
      :access_token,
      :refresh_token,
      :adapter,
    ...
    # By default, don't set a user refresh token
    ...
    DEFAULT_ENDPOINT = 'http://localhost:3001/api/v1/'.freeze
    ...
    DEFAULT_USER_AGENT = "Elefriends Ruby Gem #{Nellie::VERSION}".freeze
